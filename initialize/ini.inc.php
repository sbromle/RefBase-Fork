<?php
	...
	// The URL path to the logo image that's displayed in the refbase header:
	// (the URL path must be given relative to the root level of your refbase script directory)
